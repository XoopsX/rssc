<?php
// $Id: rssc_block.php.\040CDS\040Patch.php,v 1.1 2012/04/08 23:42:20 ohwada Exp $
...
/* CDS Patch. RSS Center. 1.02. 7. BOF */
	$block['lid'] = $lid;
/* CDS Patch. RSS Center. 1.02. 7. EOF */
// no link id
	if ($lid == 0) {
...
/* CDS Patch. RSS Center. 1.02. 1. BOF */
	$lang_more = isset($param['block']['lang_more']) ? $param['block']['lang_more'] : '';
	$lang_podcast = isset($param['block']['lang_podcast']) ? $param['block']['lang_podcast'] : '';
	$unit_kb = isset($param['block']['unit_kb']) ? $param['block']['unit_kb'] : '';
/* CDS Patch. RSS Center. 1.02. 1. EOF */

/* CDS Patch. RSS Center. 1.02. 3. BOF */
	global $xoopsConfig;
	$dir_theme = XOOPS_THEME_PATH . '/' . $xoopsConfig['theme_set'] . '/modules/' . $dirname . '/parts';
	if (file_exists($dir_theme . '/rssc_block_feed_list.html'))
	{
		$template = $dir_theme . '/rssc_block_feed_list.html';
	}
	else
	{
...
/* CDS Patch. RSS Center. 1.02. 1. BOF */
	$tpl->assign('lang_more', $lang_more);
	$tpl->assign('lang_podcast', $lang_podcast);
	$tpl->assign('unit_kb', $unit_kb);
/* CDS Patch. RSS Center. 1.02. 1. EOF */

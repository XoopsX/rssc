<?php
// $Id: rssc_config_define.php.\040CDS\040Patch.php,v 1.1 2012/04/08 23:42:20 ohwada Exp $
...
/* CDS Patch. RSS Center. 1.02. 5. BOF */
	$config[181]['valuetype']   = 'text';
/* CDS Patch. RSS Center. 1.02. 5. EOF */

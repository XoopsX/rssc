<?php
// $Id: rssc_install.php.\040CDS\040Patch.php,v 1.1 2012/04/08 23:42:20 ohwada Exp $
...
/* CDS Patch. RSS Center. 1.02. 3. BOF */
	global $xoopsConfig;
	$dir_theme = XOOPS_THEME_PATH . '/' . $xoopsConfig['theme_set'] . '/modules/' . $this->_DIRNAME;
	if (file_exists($dir_theme . '/parts'))
	{
		$this->clear_compiled_tpl_by_dir($dir_theme . '/parts');
	}
	else
	{
		$this->clear_compiled_tpl_by_dir($dir_tpl . '/parts');
	}
	if (file_exists($dir_theme . '/xml'))
	{
		$this->clear_compiled_tpl_by_dir($dir_theme . '/xml');
	}
	else
	{
